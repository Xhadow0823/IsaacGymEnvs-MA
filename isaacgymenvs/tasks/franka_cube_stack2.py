# This is a task modified from FrankaLift. (20240417)
# FrankaCubeStack2
import numpy as np
import os
import torch
...
class FrankaCubeStack2(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.cfg["env"]["numObservations"] = 14+3+4 if self.control_type == "osc" else 7
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        cubeB_opts.disable_gravity = False  # modified 0122  disable cube gravity
...
# modified 01/30  add eef_pos and eef_quat into obs space, and the result is very good!!
    def compute_observations(self):
        ...
        obs += ["cubeA_quat", "cubeA_to_cubeB_pos"]  # for stacking, w/ quat
        obs += ["q_gripper"]
        obs += ["FSM_p"]
